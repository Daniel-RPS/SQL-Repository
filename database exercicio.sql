...
/* QUANTIFICANDO E ORDENANDO A QUANTIDADE DE FUNCIONARIOS */
...
WHERE
DEPARTAMENTO LIKE '%Filmes%' OR DEPARTAMENTO LIKE '%Roupas%';
...
/* QUANTIFICANDO E ORDENANDO FUNCIONARIOS POR SEXO*/
SELECT COUNT(*), SEXO
FROM FUNCIONARIOS
GROUP BY SEXO;

/* QUANTIFICANDO E ORDENANDO DEPARTAMENTOS */
SELECT COUNT(*), DEPARTAMENTO
FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO;
...
SELECT * FROM FUNCIONARIOS
WHERE
SEXO LIKE '%Masculino%' OR DEPARTAMENTO LIKE '%Jardim%';
